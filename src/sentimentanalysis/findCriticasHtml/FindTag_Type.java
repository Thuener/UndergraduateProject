...
public class FindTag_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("sentimentanalysis.findCriticasHtml.FindTag");
  ...
  public String getBuilding(int addr) {
      ...
      jcas.throwFeatMissing("building", "sentimentanalysis.findCriticasHtml.FindTag");
